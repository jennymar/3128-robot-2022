...
public class TestShooter extends NAR_PIDSubsystem {
    ...
    private static TestShooter instance;
    ...
    public static synchronized TestShooter getInstance() {
        if(instance == null) {
            instance = new TestShooter();
        }
        return instance;
    }
